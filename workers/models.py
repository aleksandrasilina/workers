...
class Worker(models.Model):
    ...
    worker_id = models.PositiveSmallIntegerField(verbose_name="ID работника",
                                                 help_text="Укажите ID работника")
    name = models.CharField(max_length=100, verbose_name="ФИО",
                            help_text="Укажите ФИО")
    team_id = models.PositiveSmallIntegerField(verbose_name="ID бригады",
                                               help_text="Укажите ID бригады")
